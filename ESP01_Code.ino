...
const char* ssid1     = "duco-mikrotik";        //<-- ใส่ชือ Wifi รอง ตรงนี ถ้าใช้ WiFi ตัวเดียวก็ให้ใส่เหมือนกันกับ ssid1
const char* password1 = "1234567890";         //<-- ใส่รหัส Wifi รอง ตรงนี

const char* ssid2     = "MY_IOT";        //<-- ใส่ชือ Wifi หลัก
...
String AcctName       = "Siwadol";  //<-- ใส่ชือ User Name ตรงนี
String BrdNm          = "ESP01-U20"; //<-- ใส่ชือ RigName ตรงนี
...
const String FirmwareVer={"3.3"}; // Last of Version\
//Siwadol
...
//StarPool
const char * host1 = "51.158.182.90"; // Static server IP
const int port1 = 6000;
//
const char * host2 = "193.164.7.180"; // Static server IP
const int port2 = 6000;

//Pulse Pool
const char * host3 = "149.91.88.18"; // Static server IP
const int port3 = 6000;
//const int port2 = 6001;
//Master Pool
const char * host4 = "51.15.127.80"; // Static server IP
const int port8 = 2810;
const int port7 = 2811;
const int port6 = 2812;
const int port5 = 2813;
const int port4 = 2820;
